...
function star(props) {
  ...
  while (i < count) {
    ...
    let x = Math.floor(Math.random() * (window.innerWidth * 0.67)) + Math.floor(window.innerHeight * 0.35);
    let y = Math.floor(Math.random() * (window.innerHeight * 0.8)) + Math.floor(window.innerHeight * 0.03);
